	...
	\begin{itemize}
		\item \textit{Tabla de Usuarios}: campos: 
				\begin{itemize}
					...
					\item Tipo de Usuario (Particular o Empresa),
					\item Dirección, 
					\item Número, 
					\item Piso,
					\item Letra,
...
\subsection{DSI 8.2: Definición de Componentes y Subsistemas de Construcción}
	...
	\begin{figure}[h]
		\begin{center}
			\includegraphics[scale=0.4]{componentes.jpg}
	...
	\begin{itemize}
		\item Subsistema \textit{GestorCorreos}.
		\item Subsistema \textit{GestorFilatelila}.
		\item Subsistema \textit{GestorEnvíos}.
		\item Subsistema \textit{GestorOficinaVirtual}.
...
\subsection{DSI 8.3: Elaboración de Especificaciones de Construcción}
	En cuanto a los componentes de la construcción son:
	\begin{itemize}
		\item \textit{GestorCorreos}.
		\item \textit{GestorFilatelila}.
		\item \textit{GestorEnvíos}.
		\item \textit{GestorOficinaVirtual}.
		\item Tabla \textit{Usuarios}: guarda información relativa a los usuarios.
		\item Tabla \textit{Asociaciones}: guarda información relativa a las asociaciones filatélicas.
		\item Tabla \textit{Productos}: guarda información relativa a los productos del Portal de Correos y el portal Filatélico.
		\item Tabla \textit{Pedidos}: guarda información relativa de los pedidos que realizan los usuarios registrados.
		\item Tabla \textit{Envíos}: guarda información relativa a los envíos que solicitan los usuarios registrados.
		\item Tabla \textit{Información}: guarda información relativa al resto del sistema.
		\item Tabla \textit{Colecciones}: guarda información relativa a las colecciones filatélicas.
	\end{itemize}
...
\subsection{DSI 11.2: Especificación de Requisitos de Implantación}
	Los requisitos de implantación son especificados a continuación:
	\begin{itemize}
		\item Los desarrolladores deberán tener los conocimientos apropiados sobre los lenguajes de programación que el sistema utiliza y otros aspectos referentes a la implementación.
		\item Se realizarán grupos de trabajo para elaborar cada una de las características del sistema y que luego serán unificadas. Por lo que deben trabajar de forma paralela y los módulos, que cada grupo desarrolla, deben estar débilmente acoplados y fuertemente cohesionados.
