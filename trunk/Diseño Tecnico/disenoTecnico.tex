	...
	\begin{itemize}
		...
		\item Clases referentes a las \textbf{Interfaces}:
				\begin{itemize}
					...
					\item Clase \textit{IUUsuario}: interfaz de usuario que nos muestra el contenido referente a la validación (login) y el registro de usuarios.
				\end{itemize}
	...
	\begin{itemize}
		...
		\item Caso de Uso \textbf{Oficina Virtual}:
					\begin{itemize}
						\item \textit{Clase}:
							\begin{itemize}
								\item Gestor de la Oficina Virtual.
		...
		\item Caso de Uso \textbf{Gestión}:
					\begin{itemize}
						\item \textit{Clases}:
							\begin{itemize}
								\item Gestor de Oficina Virtual.
								\item Gestor de Correos.
								\item IUPrincipal.
								\item Información.
							\end{itemize}
