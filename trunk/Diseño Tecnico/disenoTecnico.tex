...
\subsection{DSI 1.6: Especificación del Entorno Tecnológico}
	...
	\begin{itemize}
		\item \textbf{Hardware}:
				\begin{itemize}
					\item Sitema de Almacenamiento: disco duro con una capacidad inicial de dos terabytes (2 TB).
	...
	\begin{itemize}
		\item \textbf{Hardware}:
				\begin{itemize}
					\item Sitema de Almacenamiento: disco duro con una capacidad inicial de quinientos gigabytes (500 GB).
...
\subsection{DSI 3.1: Identificación de Clases Asociadas a un Caso de Uso}
	...
	\begin{figure}[H]
		\begin{center}
			\includegraphics[scale=0.4]{disenoLogin.jpg}
			\caption{Diagrama de clases de diseño relacionadas con registro y validación.}
		\end{center}	
	\end{figure}
	
	\begin{figure}[H]
		\begin{center}
			\includegraphics[scale=0.4]{disenoEnvios.jpg}
			\caption{Diagrama de clases de diseño relacionadas con envío de documentos y paquetes.}
		\end{center}	
	\end{figure}
	
	\begin{figure}[H]
		\begin{center}
			\includegraphics[scale=0.4]{disenoFilatelia.jpg}
			\caption{Diagrama de clases de diseño relacionadas con el portal filatélico.}
		\end{center}	
	\end{figure}
	
	\begin{figure}[H]
		\begin{center}
			\includegraphics[scale=0.4]{disenoInfo.jpg}
			\caption{Diagrama de clases de diseño relacionadas con la obtención de información de la empresa.}
		\end{center}	
	\end{figure}
	
	\begin{figure}[H]
		\begin{center}
			\includegraphics[scale=0.4]{disenoOfiVirtual.jpg}
			\caption{Diagrama de clases de diseño relacionadas con la oficina virtual.}
		\end{center}	
	\end{figure}
	
	La descripción de cada clase es la siguiente:
	\begin{itemize}
		...
		\item \textbf{Clases de Entidad:}
			\begin{itemize}
				\item \textit{Envíos}: Es la encargada de almacenar todos los envíos que se produzcan.
...
\subsection{DSI 3.2: Diseño de la Realización de los Casos de Uso}
	...
	\item \textbf{Login}:
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{seclogincorrecto.jpg}
		...
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{secloginincorrecto.jpg}
				\caption{Diagrama de secuencia de login (incorrecto).}
			\end{center}	
		\end{figure}
		
		Un usuario, previamente registrado, introduce sus datos en la aplicación y pulsa el botón "Iniciar Sesión", entonces el Gestor de usuarios comprueba los datos mediante una consulta a la base de datos y hay dos posibilidades:
			\begin{itemize}
	...
	\item \textbf{Logout}:				
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{seclogoutcorrecto.jpg}
		...
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{seclogoutincorrecto.jpg}
	...
	\item \textbf{Registro}:		
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{secregistrocorrecto.jpg}
		...
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{secregistroincorrecto.jpg}
	...
	\item \textbf{Información}:
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{secatclienteinfo.jpg}
		...
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{secinfocorporativa.jpg}
	...
	\item \textbf{Oficina Virtual}:
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{sectareas.jpg}
		...
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{secseguimiento.jpg}
		...
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{sechistorico.jpg}
		...
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{secjustificante.jpg}
	...
	\item \textbf{Filatelia}:
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{secapadrinamiento.jpg}
		...
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{secasociaciones.jpg}
		...
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{secatcliente.jpg}
		...
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{seccoleccion.jpg}
		...
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{seconlinecorrecto.jpg}
	...
	\item \textbf{Envíos}
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{secenviocorrecto.jpg}
		...
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.4]{secenvioincorrecto.jpg}
